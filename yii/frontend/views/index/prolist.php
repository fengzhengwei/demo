  ...
  <body>
    <div class="maincont">
     ...
     <?php foreach ($res as $key => $value) { ?>
      <dl>
       <dt><a href="?r=index/proinfo"><img src="http://www.ldd.com/PHP12/demo/yii/backend/web/images/<?php echo $value['img']?>" width="100" height="100" /></a></dt>
       <dd>
        <h3><a href="?r=index/proinfo"><?php echo $value['name']?></a></h3>
        <div class="prolist-price"><strong><?php echo $value['price']?></strong></div>
       </dd>
       <?php }?>
