...
<div class="panel admin-panel">
  ...
  <div class="padding border-bottom">
    ...
    <form method="post" class="form-x" action="?r=index/showes">      
      ...
      <tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="?r=index/savess&id=<?php echo $v['id'] ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="?r=index/deletes&id=<?php echo $v['id'] ?>"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
        <?php } ?>
      </div>
    </form>
