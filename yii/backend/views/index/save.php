...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="?r=index/save">      
      <div class="form-group">
        <div class="label">
          <label>商品名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input" name="title" value="<?php echo $row['title'] ?>" />
          <div class="tips"></div>
        </div>
        <input type="hidden" class="input" name="goods_id" value="<?php echo $row['goods_id'] ?>" />
      </div>
      <div class="form-group">
        <div class="label">
          <label>图片：</label>
